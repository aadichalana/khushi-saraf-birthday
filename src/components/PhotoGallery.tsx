...
const photos: Photo[] = [
  ...
  {
    url: Pic4,
    caption: "Happy Birthday to my forever confidant and the person who makes life so much brighter! Love you to the moon and back. and you are pretty than moon.🌙❤️"
  },
  {
    url: Pic5,
  ...
  <AnimatePresence mode="wait">
    {photos.map(
      ...
      <motion.button
        ...
        onClick={onComplete}
      >
        Well i have written something for you Khushi❤️
      </motion.button>
    </motion.div>
  );
};
